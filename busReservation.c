...
void login()
{
  char userName[20] = "pintuhembram";
  char passWord[10] = "Bset@2022";
  char matchPass[10];
  char matchUser[10];
  int value;
  redColor();
...
void busLists()
{
  ...
  printf("-----------------------------------------------------------------------------------------");
  resetColor();
  printf("\n1\tSarthi Bus         \tBhadarak to Anandapur  \tRs.70   \t\t07:00  AM");
  printf("\n2\tLaxmi Bus           \tAnandapur To Bhadarak  \tRs.55    \t\t01:30  PM");
  printf("\n3\tMahalaxmi Bus        \tAllahabad To Gorakhpur\tRs.40    \t\t03:50  PM");
  printf("\n4\tArupanada Bus        \tPokhara To Benigha    \tRs.70    \t\t01:00  AM");
  printf("\n5\tSarbani Bus         \tMaitidevi To Janakpur \tRs.55    \t\t12:05  AM");
  printf("\n6\tNayak Bus           \tMadhubani to Patna    \tRs.40    \t\t09:30  AM");
  printf("\n7\tMahavaratha Bus       \tPatna To Gaya         \tRs.70   \t\t11:00  PM");
  printf("\n8\tManshi Bus            \tBegusarai To Patna     \tRs.55    \t\t08:15  AM");
  printf("\n9\tGhatanga Basini        \tGaya To Chhapra       \tRs.40    \t\t04:00  PM");
  printf("\n");
